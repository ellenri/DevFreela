...
namespace DevFreela.UnitTests.Application
{
    public class DeleteProjectHandlerTests
    {
        ...
        {
            // Arrange
            var project = new Project("Projeto teste A", "Um projeto de teste", 1, 2, 2000);
        ...
        [Fact]
        public async Task ProjectDoesNotExist_Delete_ReturnsError_NSubstitute()
        {
            // Arrange
            var repository = Substitute.For<IProjectRepository>();
        ...
        public async Task ProjectDoesNotExist_Delete_ReturnsError_Moq()
        {
            // Arrange
